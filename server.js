...
app.get('/',(request, response)=>{
    db.collection('speciesName').find().toArray()
    .then(data => {
...
app.post('/api', (req,res) => {
    ...
    db.collection('speciesName').insertOne(
        req.body
    )
    .then(result => {
        console.log(result)
...
app.post('/massinsert', (req,res) => {
    ...
    //console.log(test)
    db.collection('speciesName').insertMany(
...
app.put('/updateEntry', (req,res) => {
    ...
    console.log(req.body)
    db.collection('speciesName').findOneAndUpdate(
        {name: req.body.name},
        {
            $set:  req.body  
        },
...
app.delete('/deleteEntry', (request, response) => {
    db.collection('speciesName').deleteOne({speciesName: request.body.name})
    .then(result => {
